    ...
    return(
        <>
            <div className={'text-center my-5'}>
               <button onClick={() => setIsOpen(true)} className={'plus bg-[#347928] hover:bg-[#225719] transition duration-[300ms] text-[#FFFFFF] rounded-full px-3 py-2'}>Открыть окно</button>
